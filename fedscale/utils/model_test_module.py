...
def client_test_model(client_id, model, test_data, device='cpu', criterion=nn.NLLLoss(), tokenizer=None):
    ...
    logging.info('Testing Client {}: Test set: Average loss: {}, Top-1 Accuracy: {}/{} ({}), Top-5 Accuracy: {}'
